...
*PROBLEM SET 6
clear all
cd "/Users/vrangbaek/Dropbox/KU/Polit/Oekonometri B/F15/Undervisningsnoter/7 (PS5, PS6)/"
cap log close
...
* Group work
	* Test for multicollinearity. Source: http://bit.ly/1x8UkHT
	quietly regress m2 rooms toilets
	di 1-e(r2)
	quietly regress rooms m2 toilets
	di 1-e(r2)
	quietly regress toilets m2 rooms 
	di 1-e(r2)
...
regress logprice m2 rooms toilets if location=="KBH Ø"
gen SSR_3=e(rss)
