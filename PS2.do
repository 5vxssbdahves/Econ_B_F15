...
*PROBLEM SET 2
clear all
cd "/Users/vrangbaek/Dropbox/KU/√òkonomi/√òkonometri B/F15/Ugesedler/2/"
* Installér outreg2-pakken. NB: Kør kun første gang, kommentér derefter ud med *
* ssc install outreg2 
...
outreg2 lnrxtot using results, replace excel tex(frag) nocons

regress wcloth lnrxtot if dmale==1
outreg2 lnrxtot using results, append excel tex(frag) nocons
